              ...
              {loading ? (
                ...
                candidates.map((c, i) => (
                  <div 
                    ...
                    className="grid grid-cols-12 items-center px-6 py-4 rounded-xl bg-white/5 border border-transparent hover:border-primary/20 transition-all group cursor-pointer active:scale-[0.99]"
                  >
                    ...
                    <div 
                      className="col-span-7 text-[11px] font-mono text-slate-400 truncate pr-8 group-hover:text-slate-100 transition-colors"
                      title={c.filename}
                    >
                      {c.filename}
                    </div>
